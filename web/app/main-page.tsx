    ...
    <Page title='Home'>
      ...
      >
        <Text as='p' variant='bodyMd'>
          Call a NextJS api route from within your app. The request is verified using session
          tokens.
        </Text>
        {data && (
      ...
      >
        <Text as='p' variant='bodyMd'>
          Use Apollo Client to query Shopify&apos;s GraphQL API. The request uses online session
          tokens.
        </Text>
        <Text as='p' variant='bodyMd'>
          Response:
